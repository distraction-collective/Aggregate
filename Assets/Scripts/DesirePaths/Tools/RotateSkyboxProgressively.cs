...
namespace DesirePaths.Tools {
  /// <summary>
  /// Rotates skybox parameter according to a float. Does it in LateUpdate to be
  /// in sync with other animation update cycles. -Gucci
  /// </summary>
