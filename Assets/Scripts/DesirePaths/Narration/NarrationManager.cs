...
namespace DesirePaths.Narration
{
    public class NarrationManager : MonoBehaviour
    {
        ...
        private void Awake()
        {
            UpdateNarrationAction += OnNarrationUpdated;
        }
        ...
        void OnNarrationUpdated()
        {
            ...
            {
                if(NarrationUpdated != null) NarrationUpdated.Invoke(line);
            }
        }
        ...
        {
            line = "";
            if (_script == null) return ScriptResponseCode.NO_SCRIPT;
            if (_scriptLines == null || _scriptLines.Count == 0) LoadScript();
            if (_currentLine == _scriptLines.Count) return ScriptResponseCode.COMPLETE;
